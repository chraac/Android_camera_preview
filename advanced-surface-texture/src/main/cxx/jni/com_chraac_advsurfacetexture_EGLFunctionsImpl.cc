...
constexpr const char *kLogTag = "JNIAdvSurfaceTexture";
constexpr const char *kEGLFunctionsClassName =
    "com/chraac/advsurfacetexture/EGLFunctionsImpl";
constexpr const char *kEGLImageClassName =
    "com/chraac/advsurfacetexture/EGLImageKHR";
 ...
 * Signature:
 *   (JLandroid/opengl/EGLDisplay;Landroid/hardware/HardwareBuffer;)Lcom/chraac/advsurfacetexture/EGLImage;
 */
jobject JNICALL JniNativeCreateImageFromHardwareBuffer(
  ...
  auto &inst = JNIAdvSurfaceTexture::GetInstance();
 ...
 * Signature:
 * (JLandroid/opengl/EGLDisplay;Lcom/chraac/advsurfacetexture/EGLImage;)V
 */
 ...
 * Signature: (JILcom/chraac/advsurfacetexture/EGLImage;)V
 */
...
const JNINativeMethod g_methods[] = {
    {"nativeCreateImageFromHardwareBuffer",
     ...
     "Lcom/chraac/advsurfacetexture/EGLImageKHR;",
     (void *)JniNativeCreateImageFromHardwareBuffer},
    {"nativeDestroyImageKHR",
     "(JLandroid/opengl/EGLDisplay;Lcom/chraac/advsurfacetexture/"
     "EGLImageKHR;)V",
     (void *)JniNativeDestroyImageKHR},
    {"nativeEGLImageTargetTexture2DOES",
     "(JILcom/chraac/advsurfacetexture/EGLImageKHR;)V",
...
bool JNIAdvSurfaceTexture::Load(JavaVM *jvm, JNIEnv *env) {
  ...
  UniquePtrJClass egl_handler_clazz(
      ...
      GetJNIDestructorFunctor(jvm, &JNIEnv::DeleteLocalRef));
  if (!functions_class || !image_clazz || !egl_handler_clazz) {
...
void JNIAdvSurfaceTexture::Unload(JNIEnv *env) {
...
void *
JNIAdvSurfaceTexture::GetEGLHandlerFormEGLObjectHandle(JNIEnv *env,
                                                       jobject egl_object) {
  if (!egl_object) {
    return nullptr;
  }
...
jobject JNIAdvSurfaceTexture::CreateEGLImageFormEGLImageKHR(JNIEnv *env,
                                                            EGLImageKHR image) {
  if (!image) {
    return nullptr;
  }
